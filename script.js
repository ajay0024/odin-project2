...
function playSingleRound(playerSelection, computerSelection) {
    ...
    displayRoundPlay(playerSelection,computerSelection, winner);
    return winner
}
function displayRoundPlay(a,b,winner){
    ...
    playAgainButtonNode.textContent = "Play Again";
    playAgainButtonNode.addEventListener("click",()=> replaceNode(newNode, gameNode))
